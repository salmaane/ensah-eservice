                        ...
                        <tbody>
                            <?php foreach ($modules_merged as $row) { ?>
                                <tr id="module_row">
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#Modal" data-bs-whatever="Modifier" data-id_module="<?= $row->id_module ?>" onclick="setModuleId(event)">Modifier</button>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-whatever="Supprimer" data-module_name="<?= $row->name ?>" data-id_module="<?= $row->id_module ?>" onclick="setModuleId2(event)">Supprimer</button>
                                    </td>
                                </tr>
                            <?php } ?>
