...
<body class="body">
  ...
  <div class="me-2 bg-light card-deck p-5 card me-1">
      <h1 class="mb-4">Créer filiere</h1>
      ...
      <p class="fw-bold">Veuillez entrez les informations du filiere à créer :</p>

      <form class="w-50 mb-5" method="post">
        <div class="mb-3 w-50">
          <label for="name" class="form-label">Nom du filiere</label>
